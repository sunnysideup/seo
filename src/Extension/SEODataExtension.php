        ...
        if (empty($keyword)) {
            ...
            if ($duplicates->count()) {
                ...
                $result->addFieldError(
                    'FocusKeyword',
                    sprintf(
                        _t(self::class.'.FocusKeywordIsNotUnique', "This keyword is not unique. It is also used by '%s'"),
                        $items
                    ),
                    ValidationResult::TYPE_ERROR,
                    '',
        ...
        if (empty($record->MetaTitle)) {
            ...
            if (strlen((string) $metaTitle) < 45) {
                ...
                $result->addFieldMessage(
                    'MetaTitle',
                    _t(self::class.'.MetaTitleLengthGood', 'The SEO title has a nice length.'),
                    ValidationResult::TYPE_GOOD
                );
            }
            ...
            if ($duplicates->count()) {
                ...
                $result->addFieldError(
                    'MetaTitle',
                    sprintf(_t(
                        self::class.'.MetaTitleDuplicated',
    ...
    public function validateMetaDescription(ValidationResult $result)
    {
        ...
        if (empty($desc)) {
            $result->addFieldError(
                'MetaDescription',
                _t(
                    self::class.'.MetaDescriptionEmpty',
            ...
            if (strlen((string) $desc) < 120) {
                $result->addFieldError(
                    'MetaDescription',
                    _t(
                        self::class.'.MetaDescriptionTooShort',
